...
Pod::Spec.new do |s|
  ...
  s.name         = "SPFastPush"
  s.version      = "0.0.5"
  s.summary      = "Use Macro Fast NavigationController push next VC，use KVC assign parameter，return current VC Object，and Fast Pop anther VC.使用宏帮助导航控制器快速push下一个VC,利用KVC传入参数,也可以快速返回导航栈内指定的VC"
  ...
  s.source       = { :git => "https://github.com/lishiping/SPFastPush.git", :tag => "0.0.5" }
